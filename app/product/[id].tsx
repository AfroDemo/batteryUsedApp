...
export default function ProductDetailScreen() {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      if (id) {
        const foundProduct = BATTERIES.find(b => b.id === id);
        if (foundProduct) {
          setProduct(foundProduct);
          setProductIsFavorite(isFavorite(foundProduct.id));
        }
      }
      setIsLoading(false);
    }, 500);
        ...
        >
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={styles.compatibilityContainer}>
              ...
              <Text style={styles.compatibilityValue}>{product.compatibility}</Text>
            </View>
            
            <View style={styles.healthContainer}>
              <Text style={styles.healthLabel}>Battery Health:</Text>
              <BatteryHealthIndicator 
                percentage={product.capacityPercentage} 
                size="lg"
              />
            </View>
