...
export default function AdminOrderDetailsScreen() {
  ...
  const updateOrderStatus = async (newStatus: "pending" | "processing") => {
    if (!order) return;
    setIsUpdating(true);
    try {
          ...
          <View style={styles.statusContainer}>
            ...
            <View style={styles.statusButtons}>
              ...
              <TouchableOpacity
                style={[
                  styles.statusButton,
                  order.status === "processing" && styles.statusButtonActive,
                ]}
                onPress={() => updateOrderStatus("processing")}
                disabled={isUpdating || order.status === "processing"}
              >
                <Text style={styles.statusButtonText}>Set Processing</Text>
              </TouchableOpacity>
            </View>
          </View>
        </Card>
